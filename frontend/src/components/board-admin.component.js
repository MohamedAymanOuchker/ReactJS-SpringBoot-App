...
function handleModalToggle(modalId) {
...
export default class BoardAdmin extends Component {
  ...
  componentDidMount() {
    ...
    if (!allUsers) this.setState({ redirect: "/home" });
    this.setState({ allUsers: allUsers, userReady: true });
  }
            ...
            <div className="sm:flex">
              ...
              <div className="flex items-center ml-auto space-x-2 sm:space-x-3">
                <button
                  ...
                  onClick={() => handleModalToggle("add-user-modal")}
                  ...
                  <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    {/* {allUsers.map((user, index) => ( */}
                      ...
                      >
                        ...
                        <td classNameName="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                          <div classNameName="flex items-center">
                            {status === "Active" ? (
                              <div classNameName="h-2.5 w-2.5 rounded-full bg-green-400 mr-2"></div>
                            ) : (
                              <div classNameName="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div>
                            )}
                            {status}
                          </div>
                        </td>
                        <td className="p-4 space-x-2 whitespace-nowrap">
                          <button
                            ...
                            onClick={() => handleModalToggle("edit-user-modal")}
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleModalToggle("delete-user-modal")
                            }
          ...
          <div className="relative w-full h-full max-w-md px-4 md:h-auto">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
              <div className="flex justify-end p-2">
                <button
                  type="button"
                  onClick={() => handleModalToggle("delete-user-modal")}
                  className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-700 dark:hover:text-white"
                  data-modal-toggle="delete-user-modal"
                >
                  <svg
